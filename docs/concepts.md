...
I am interested in [philosophically sophisticated grading](https://chrisbrejon.com/articles/what-makes-a-good-picture-formation/)), nonlocal tonemapping, etc., for satellite imagery, but this project hopes to provide a foundation for work in that direction, not to carry it out. Potato’s core purpose ends at ΔE.
