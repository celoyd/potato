...
0. [Toplevel readme](../README.md). 🔰 _The front page introduction to the project: examples, license, and credits._
1. [Quickstart](quickstart.md). ⚙️ _To see the code work, without worrying yet about what it’s doing._
2. [Potato’s main features](features.md). _The unusual parts of this project compared to other pansharpening approaches._
    1. Preface: [Beyond aspatial images](features.md#preface-beyond-aspatial-images). 🔰 _Satellite images are not quite the same as “normal” images._
